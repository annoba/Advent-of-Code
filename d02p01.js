...
find the min and max number of each row and
add the diff max-min of each row = checksum */
...
let minmaxDiff;		//declare variable to store difference of min and max value of each row in each iteration
let checksum = 0;	// declare variable to sum the difference values of each row
